...
include_once drupal_get_path('module', 'arctic').'/inc/campaign/onpage.inc';
?>

<div class="container-fluid">
  <div id="arctic_campaign_onpage">
    <?php print drupal_render(drupal_get_form('arctic_campaign_onpage_form')); ?>
  </div>
</div>
