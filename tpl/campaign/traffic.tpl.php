...
include_once drupal_get_path('module', 'arctic').'/inc/arctic.campaign-traffic.inc';
?>

<div class="container-fluid">
  <div id="arctic_campaign">
    <?php print drupal_render(drupal_get_form('arctic_campaign_traffic_form')); ?>
  </div>
</div>
